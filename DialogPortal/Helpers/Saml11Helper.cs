...
namespace SamlHelperLib
{
    ...
    {
        public static string GetToken(SamlAssertion assertion)
        {
        ...
        private static void SignSamlAssertion(SamlAssertion assertion)
        {
            ...
            var certificate2 = new X509Certificate2(@"C:\Data\SVN-Client\dialog\Dialog\DialogPortal\Certificates\SamlTokenSigningCertificate.pfx", "");
