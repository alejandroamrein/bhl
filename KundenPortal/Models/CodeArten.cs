...
namespace Dialog.Behoerdenloesung.Sitzungen.UI.Web.Models
{
    public class CodeArten
    {
        ...
        public static GES_BemerkArt GESBemerkArt;
        public static AFG_InternArt AFGInternArt;
    ...
    public class CodeArtList : IEnumerable<CodeArt>
    {
        ...
        public Dictionary<string, CodeArt> ItemsByCode { get; set; }
    ...
    public class AFG_InternArt : CodeArtList
    {
        public AFG_InternArt() : base("AFG_InternArt")
        {
            //64057    GMX_InternArt 2   Akzeptiert Akzeptiert   1
            //64058    GMX_InternArt 1   Abgelehnt Abgelehnt   2
        }
    }
    ...
    public class GES_DokumentTyp : CodeArtList
    {
        ...
        {
            //3162	GES_DokumentTyp	1	Einladung(öffentlich)      
            //3165	GES_DokumentTyp	4	Protokoll NULL	
        }
    }

    public class GES_BemerkArt : CodeArtList
    {
        public GES_BemerkArt() : base("GES_BemerkArt")
        {
            //64076	GES_BemerkArt	1	Intern Intern	
            //64077	GES_BemerkArt	2	Extern Extern   
        }
    }
    ...
    public class GES_Eigner : CodeArtList
    {
        ...
        {
            //3197	GES_Eigner	2	Projektteam Projektteam	
            //3198	GES_Eigner	3	Extern Extern	
            //3200	GES_Eigner	1	Verantworticher Verantw.    
        }
    }
